...
export const metadata = {
  ...
  date: '2025-05-24',
  readTime: 'About 4 mins',
  description:
    'A place on the internet I call home. Home to the digital me and the various odds and ends I find along the way. This is the story of making that home.',
  tags: ['portfolio'],
  isPublished: true,
  isFeatured: true,
  type: 'post',
